...
const index = motto.indexOf('cool');
const boolean = index === 0;
console.log(boolean);
...
const updatedLength = motto.length;
const ratio = ((updatedLength / mottoLength) * 100).toFixed(2) + '%';
console.log(ratio);
...
//    1 4 1 5 9 2 6 5 3 5
//Log out the array.
let numbers = [1, 4, 1, 5, 9, 2, 6, 5, 3, 5]; console.log(numbers);
